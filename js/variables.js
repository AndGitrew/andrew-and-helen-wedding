...
var	mobileMenuTitle = "Menu",					//The title of the mobile menu
	...
	map_initial_latitude = 45.432603525511915,			//Google map initial Latitude. If "null", the latitude of the first marked will be used
	map_initial_longitude = -75.74096852534183,		//Google map initial Longitude. If "null", the longitude of the first marked will be used
